                        ...
                        @if(auth()->user()->isAdmin())
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
											<span class="menu-link">
												...
												<span class="menu-title">الكباتن</span>
												<span class="menu-arrow"></span>
											</span>
                                <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('captains.create')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                                <span class="menu-title">اضافة</span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
											<span class="menu-link">
												...
												<span class="menu-title">الأماكن</span>
												<span class="menu-arrow"></span>
											</span>
                                <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                    ...
                    <div class="menu-sub menu-sub-accordion show">
                        @if(auth()->user()->isAdmin())
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('constants.create')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                                <span class="menu-title">عرض</span>
