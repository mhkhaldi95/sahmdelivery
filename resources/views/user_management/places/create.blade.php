...
@section('content')
    <input type="hidden" id="place_id" value="{{isset($item)?$item->id:null}}">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 form p-4 fw-bold mb-n2">
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 {{(request('trips') && request('trips') == 'show')?'':'active'}}" data-bs-toggle="tab"
                           href="#kt_ecommerce_add_product_general">معلومات المكان</a>
                    </li>
                    <!--end:::Tab item-->
                    @if(isset($item))
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show {{(request('trips') && request('trips') == 'show')?'':'active'}}" id="kt_ecommerce_add_product_general"
                         role="tab-panel">
                        <!--end:::Tabs-->
                        @include('validation.alerts')
                        <!--begin::Form-->
                        <form id="kt_docs_formvalidation_text" class="form p-4" method="post"
                              action="{{isset($item)?route('places.store',['id'=>$item->id]):route('places.store')}}"
...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-10">
                                    <!--begin::Label-->
                                    <label class=" fw-semibold fs-6 mb-2">اسم المستخدم</label>
                                    <!--end::Label-->
                                ...
                                <!--end::Input group-->
                                <input type="hidden" value="{{\App\Constants\Enum::PLACE}}" name="role">
                                ...
                                <div class="col-lg-12 ">
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <textarea name="address"
                                                  class="form-control mb-2">{{isset($item)?$item->address:old('address')}}</textarea>
                                        <!--end::Input-->
                                    </div>
                    ...
                    <div class="tab-pane fade show form p-4 {{(request('trips') && request('trips') == 'show')?'active':''}}" id="kt_ecommerce_add_product_reviews"
                         role="tab-panel">
                        <div class="card">
