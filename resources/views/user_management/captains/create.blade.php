...
@section('content')
    ...
    <input type="hidden" id="captain_id" value="{{isset($item)?$item->id:null}}">
    <!--begin::Post-->
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 form p-4 fw-bold mb-n2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                           href="#kt_ecommerce_add_product_general">معلومات الكابتن</a>
                    </li>
                    <!--end:::Tab item-->
                    @if(isset($item))
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general"
                        ...
                        <form id="kt_docs_formvalidation_text" class="form p-4" method="post"
                              action="{{isset($item)?route('captains.store',['id'=>$item->id]):route('captains.store')}}"
...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-1 col-form-label fw-bold fs-6">{{__('lang.Avatar')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Image input-->
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{isset($item)?$item['photo_path']:asset('assets/media/default.png')}})">
                                            <!--begin::Preview existing avatar-->
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{isset($item)?$item['photo_path']:asset('assets/media/default.png')}})"></div>
                                ...
                                <input type="hidden" value="{{\App\Constants\Enum::CAPTAIN}}" name="role">
                                <!--end::Input group-->
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                var url = '{{route("captains.trips",[":id"])}}';
