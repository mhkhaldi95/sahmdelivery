                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Add customer-->
                            <a href="{{route('captains.create')}}" type="button" class="btn btn-primary" >{{__('lang.add')}}</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
...
{{--                                    <input class="form-check-input" id="all_checked" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_customers_table .form-check-input" value="1" />--}}
                            ...
                            <th class="min-w-125px" style="padding-right: 15px">{{__('lang.phone')}}</th>
                            <th class="min-w-125px" style="padding-right: 15px">الحالة</th>
            ...
            var handleDeleteRows = () => {
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        var url = '{{route("captains.delete",[":id"])}}';
                ...
                cancelDeleteButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function (e) {
                        ...
                        // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                        Swal.fire({
                            text: "هل أنت متأكد من أنك تريد الغاء حذف " + customerName + "?",
                            icon: "warning",
                            showCancelButton: true,
                            buttonsStyling: false,
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        text: "لقد  ألغيت حذفت " + customerName + "!.",
                                        icon: "success",
                                        buttonsStyling: false,
